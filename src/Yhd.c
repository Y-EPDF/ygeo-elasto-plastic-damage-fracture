...
YINT nnopo; YINT ncstep; YINT ibc;
DBL *d1nmct; YINT *i1nopr; YINT *i1nowe; YINT **i2noid;

// { YINT inopo; YINT jnopo; YINT wet;
// 
//   wet = 2 - (ncstep % 2);
// 
//   //! Loop over nodes
...
{ YINT inopo; YINT jnopo; YINT wet; YINT old_wet;
...
YINT nnopo; YINT ibc; DBL *d1nmct;
YINT *i1nowe; YINT **i2noid;
DBL *d1nccx; DBL *d1nccy; 
YINT *i1nopr; DBL *fluvol;
YINT dim;

{ YINT inopo; DBL x0; DBL x1; DBL y0; DBL y1; DBL A; DBL l; DBL r0; DBL r1; DBL lx; DBL ly;
...
YINT ihftyp; DBL dhfflp; DBL dhfflq; YINT hfarow; DBL **d2hfaf; DBL dctime;
DBL *d1nfp; DBL gravacc; YINT nnopo; DBL *d1nccx; DBL *d1nccy; DBL **d2wtlev;

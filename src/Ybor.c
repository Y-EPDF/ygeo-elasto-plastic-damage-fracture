...
DBL Ybor2factor(dctime,npaf,Ts,Te,d1pres)
  DBL  dctime; YINT  npaf; DBL  Ts; DBL  Te;
  DBL *d1pres;
{ DBL factor;
  DBL Tstep;
  YINT Nstart;
...
static void Ybor2JOINTS(  /* joints on edges only  */
  ...
  YINT    nelem; DBL   dctime;
  YINT    jprop;
  YINT    nborh; YINT     nbpaf; DBL  *d1bprs; DBL    dbbuf;
        ...
        { if(((d1xmin[iborh]<d1nccx[i0])&&(d1nccx[i0]<d1xmax[iborh])) &&
          ...
          { /* 1st node - transform to local coord. system  */
            ...
            { L=Lb[iborh]-v0;
              ...
              d1nfcx[i0]=d1nfcx[i0]-dpres0*nx/R3-dpres1*nx/YR6;
              d1nfcy[i0]=d1nfcy[i0]-dpres0*ny/R3-dpres1*ny/YR6;
              d1nfcx[i1]=d1nfcx[i1]-dpres0*nx/YR6-dpres1*nx/R3;
              d1nfcy[i1]=d1nfcy[i1]-dpres0*ny/YR6-dpres1*ny/R3;
  } } } } } } 
...
static void Yinterfluid2JOINTS(  /* broken joints or edge only  */
  ...
  YINT    nelem; DBL   dctime;
  YINT    jprop;
  YINT    nsour; YINT    nsdim; YINT    nspaf; YINT    nssaf;

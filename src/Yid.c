...
static void Yid2TRITRI(              /* Triangle to Triangle */
  ...
  YINT    nelem;
  DBL   dcstec; DBL   diezon; YINT    iprop; YINT    jprop;
  ...
  DBL  **d2sldis;
  YINT  *i1elcf; YINT  *i1elpr; YINT  *i1icff; YINT  *i1iecn; YINT  *i1iect;
  YINT **i2elto;
  DBL *d1elfr; YINT iusefn; DBL *d1elpe; DBL *d1elpt;
  YINT *i1pexc;
{ YINT kprop,icontact,ielem,jelem,icoup,jcoup,it,jt,in,jn,ie,je,ip,jp,np;

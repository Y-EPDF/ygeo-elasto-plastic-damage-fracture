...
static void Yfrd2TRIANGLE(  /* fracture triangle  */
  ...
  DBL  *d1nvcy; DBL  *d1elfs; DBL *d1sdel; YINT *i1elpr; YINT *i1nobf;
  YINT  *i1nopr; YINT **i2elto;
{ DBL vx[3], vy[3], x[3], y[3], xi[3], yi[3];
  DBL xc,yc,vxc,vyc,ratio,volc,voli;
  YINT nelem, nnopo, inopo;
  YINT i,ielem;
  YINT i1t[12]={0,2,4,8, 1,6,5,9,  11,10,3,7 };
  DBL dpefs;
...
{ YINT nelest, nnopst;
  ...
  if((ydn->nnopo)!=nnopst)ydi->diedi=YR5*ydi->diezon;
}

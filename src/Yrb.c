...
static void Yrb2CREATE(   /* created 1RBAR element  */
  ...
  YINT    nelem; YINT   nsbar; YINT   mrepo; YINT *n0repo;
  ...
  YINT  *i1elpr;  YINT **i2elto; YINT *i1ptyp;   YINT *i1rrpn;   YINT  *i1srpf;
  YINT *i1rmyel;  
  DBL *d1spea;
  YINT **i2relto; YINT *i1rprop; YINT *i1refbar; YINT *i1sbpr;   
  DBL *d1rsctrx; DBL *d1rsctry; YINT **i2rbedn;
{ YINT ielem,isbar,iprop,irpo,bezs,indk;
  ...
  YINT i,j,k=0,ncrepo=0,nrjoint=0;
  YINT *i1rmyelT;
...
static void Yrb2CARENT( /*carent coordinates*/
  ...
  YINT nelem; YINT nsbar; YINT *n0repo;
  DBL *d1nccx; DBL *d1nccy; DBL *d1nvcx; DBL *d1nvcy;
  DBL *d1rccgx; DBL *d1rccgy;  DBL *d1rvcgx; DBL *d1rvcgy; 
  DBL *d1riLcK;  DBL *d1riLcE;  DBL  *d1riLcZ;
  YINT **i2elto; YINT *i1rrpn;   YINT  *i1srpf;  YINT *i1rmyel; 
...
static void Yrb2FORCE(  /* nodal force RBAR elements   */
  ...
  YINT *i1srpf;  YINT *i1rprop;   YINT *i1rrpn;  YINT *i1rmyel; YINT *i1refbar;
  YINT **i2elto; DBL *d1spea;
  YINT nohys; DBL *d1ohyx; DBL *d1ohyy; DBL *d1ohys; DBL *d1ohyt; DBL dohyp; 
  YINT *i1ohyt;
  DBL dctime; YINT ncstep;  
  DBL *d1rbsig; DBL *d1rbfrc; DBL *d1rbstr;
  YINT *i1sbac;

{ YINT imyelem,ip,in,jn,kn,ihys;
...
static void Yrb1RJOINT(  /* 1D joint element  */
  ...
  DBL *d1sdiam; DBL *d1smmdiam; DBL *d1crlcr; YINT *i1sbpr;
  DBL *d1sfc;   DBL *d1mpsfc;
  DBL *d1sfy; DBL *d1epssh; DBL *d1sfu; DBL *d1epsu; DBL *d1sfbr; DBL *d1epsbr; 
  YINT *i1elpr; YINT *i1rprop; YINT **i2elto; YINT **i2relto; YINT mrepo; YINT *i1refbar;
  YINT *i1rmyel;
  YINT *i1myjoint;
  DBL *d1rsctrx; DBL *d1rsctry; DBL *d1rvcgx; DBL *d1rvcgy; 
  DBL *d1pela; DBL *d1pemu; YINT nprop;
  DBL dctime; YINT ncstep;
  YINT *i1ptyp;
  DBL *d1rjsig; DBL *d1rjtau; 
  YINT *i1petyp; DBL *d1peem; DBL *d1peex; DBL *d1peey; YINT *i1usan;
  YINT *i1sbty; DBL *d1elfs;
  YINT *i1pexc; YINT *i1sbac;
  ...
  DBL **d2rjfrv; YINT **i2rbedn;
{ YINT i0,i1,i2,i3,i0r,i1r;
  YINT i,imyelemj;
  ...
  static YINT* indic=INT1NULL; //indicator if crack is open
  ...
  static YINT* icrac=INT1NULL; // flag if crack has an activated bar
	  ...
	  {fprintf(out2,"ncstep: %d \t i: %d \t dsigma: %.6f \t 2 \n",ncstep,i, dsigma); }*/
        ...
        { /* The bar is elastic-plastic-brittle */
          ...
          { slpnor=slpnor-d1slpin[i]; //! Current normalized slip - normalized slip when joint @ 1D joint reference point is softening
            ...
            eb=(-young/YR6)*log(10*(d1epsmax[i]-epsy)); //! E_b in eq. 40
...
{ YINT i=0,j,k,iprop,indic=0,temp;
  YINT i0,i1,i2,ir,ij1,ij2;
